...
namespace RaycastEngine
{
	class Camera
	{
		...
		//--per column perpendicular distance to the nearest ground level wall--//
		//--used to cull (occlude) sprites that sit behind walls--//
		...
		public Camera(int width, int height, int texWid, Rectangle[] slices, Level[] levels)
		{
			...
			//--init the z buffer (one entry per screen column)--//
        ...
        */
		public void castLevel(int x, int[,] grid, Rectangle[] _cts, Rectangle[] _sv, Color[] _st, int levelNum)
		{
			...
			//--store the ground level wall distance for sprite occlusion--//
			if (levelNum == 0) ZBuffer[x] = perpWallDist;
		...
		//==============================================================//
		//== accessors used by sprite rendering / occlusion           ==//
		//==============================================================//

		/// <summary>Current camera world position.</summary>
		public static Vector2 getPos() { return pos; }

		/// <summary>Current camera facing direction.</summary>
		public static Vector2 getDir() { return dir; }

		/// <summary>Current camera plane (FOV).</summary>
		public static Vector2 getPlane() { return plane; }

		/// <summary>Per column perpendicular wall distance, for sprite occlusion.</summary>
		public static double[] getZBuffer() { return ZBuffer; }
	}
}